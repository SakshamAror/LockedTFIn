...
- If an option appears to choose, yes this is my device or no this isn't (something along those lines), choose no- other people use this device
...
For each item, get the course name and first teacher name from the courses data.
